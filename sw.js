...
const CACHE_NAME = 'tabella-esercizi-v49';
const APP_SHELL = [
  ...
  './apple-touch-icon.png', './logo.png', './primary-card-bg.jpg', './libreria-card-bg.png', './calendario-card-bg.jpg', './pazienti-card-bg.jpg'
];
